...
def array_to_msg(line):
    ...
    array_msg = Occlusion_pose_pb2.Float1DArray()
...
def matrix_to_msg(matrix):
    ...
    matrix_msg = Occlusion_pose_pb2.Float2DArray()
    if matrix is None:
        return matrix_msg
...
def msg_to_matrix(msg, n_lines=None, n_cols=None):
    ...
    :param msg: Message of type Float2DArray, as defined in vision_algorithms.proto
...
def msg_to_image(msg, height=None, width=None):
    ...
    :param msg: Message of type Image, as defined in vision_algorithms.proto
...
def image_to_msg(img):
    ...
    if img.ndim == 2:  # Expand dimensions if the image is grayscale
        ...
        logging.error("Detected image with incorrect number dimensions. Must be either 3xMxN (Color image) or "
                      "MxN (grayscale).")
        return Occlusion_pose_pb2.Image()
    ...
    # Build Image message
    img_msg = Occlusion_pose_pb2.Image(width=img_width, height=img_height)
